    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <div className="max-w-md mx-auto px-4 py-6 pb-20">
        ...
        <div className="space-y-4">
          ...
          {/* 唯識詞典 */}
          <Link
            href="/dictionary/weishi"
            className="block bg-white rounded-2xl p-5 border border-[#e8e8e8] hover:border-[#6b8f9e]/40 hover:shadow-md transition-all active:scale-[0.98]"
          >
            <div className="flex items-start gap-3">
