...
export const YIJING_DICTIONARY: DictionaryEntry[] = [
...

  {
    ...
    pinyin: "tài jí",
    category: "基礎概念",
    oneLiner: "宇宙最初的狀態，什麼都還沒分開之前的那個「一」。",
    plainText:
      "太極是易經的起點。想像一下，在天地還沒形成、什麼都沒有的時候，有一股渾然一體的力量，它不是空的，而是包含了一切可能性。這股力量動起來就生出陽，靜下來就生出陰。太極不是某個具體的東西，而是「一切從這裡開始」的狀態。打個比方，就像一粒種子，它還沒發芽的時候，你看不到根和葉，但根和葉的可能性都在裡面。",
    classicText:
      "《易傳·繫辭上》：「易有太極，是生兩儀，兩儀生四象，四象生八卦。」",
    source: "《易傳·繫辭上傳》",
    lifeExample:
      "你早上剛醒來、還沒開始想今天要做什麼的那一瞬間，腦子裡什麼都沒想但什麼都可能——那就是你一天的「太極」。",
    related: ["liangyi", "siyang", "bagua", "yinyang"],
  },

  {
    ...
    related: ["taiji", "yinyang", "siyang", "bagua"],
  },

  {
    ...
    related: ["taiji", "liangyi", "bagua", "yinyang"],
  },

  {
    ...
    source: "《易傳·繫辭上傳》",
    lifeExample:
      "工作時你主動出擊（陽），回家後你安靜休息（陰）。如果一個人永遠在衝（純陽），會燒盡；永遠在躺（純陰），會腐。陰陽交替，才是活的。",
    related: ["taiji", "liangyi", "siyang", "bagua"],
  },

  {
    ...
    related: ["taiji", "liangyi", "siyang", "yinyang", "qian_gua", "kun_gua"],
  },
...

  {
    ...
    source: "《周易》六十四卦",
    lifeExample:
      "你剛入職新���司（初爻），就算有能力都應該先觀察、低調（潛龍勿用）。等你站穩了、得到信任（五爻），先至可以大展拳腳（飛龍在天）。同樣是你，位置不同，策略就不同。",
