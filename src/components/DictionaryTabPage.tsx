...
/**
 * 公益辭典頁（Tab 組件，用於底部導航）
 * 不含返回按鈕，直接嵌入 App tab 系統
 */
export default function DictionaryTabPage() {
    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <header className="sticky top-0 z-10 bg-gradient-to-r from-[#1a1a2e] to-[#16213e] px-4 py-4">
        <div className="max-w-md mx-auto flex items-center gap-2">
          ...
          <h1 className="text-base font-bold text-white font-song">公益辞典</h1>
        </div>
      </header>
      ...
      <div className="max-w-md mx-auto px-4 py-6 pb-20">
        ...
        <div className="space-y-4">
          {/* 易學辭典 */}
          <button
            onClick={() => router.push("/dictionary/yijing")}
            className="w-full text-left block bg-white rounded-2xl p-5 border border-[#e8e8e8] hover:border-[#c9a84c]/40 hover:shadow-md transition-all active:scale-[0.98]"
          >
