...
import { ChevronDown, ChevronUp, Play, Phone, ArrowRight, Sparkles, Shield, RefreshCw, Users, Download } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#fafafa] pb-20">
      ...
      <div className="px-5 py-6">
        <div className="text-center mb-5">
          ...
          <p className="text-sm text-[#666] mt-1.5 font-medium leading-relaxed">点击展开每一天的精彩内容</p>
        </div>
      ...
      <div className="px-5 py-6">
        <div className="text-center mb-4">
          ...
          <p className="text-sm text-[#666] mt-1.5 font-medium leading-relaxed">只要是需要用脑子的地方，它都能派上用场</p>
        </div>
        ...
        <p className="text-center text-sm text-[#666] mt-4 leading-relaxed font-medium">
          我们不搞虚的，讲授、示范、讨论，<br/>
      ...
      <div className="px-5 py-6">
        ...
        <div className="text-center mb-5">
          ...
          <p className="text-sm text-[#666] mt-1.5 font-medium leading-relaxed">点击播放，听听她们的真实分享</p>
        </div>
      ...
      <div className="px-5 py-6">
        ...
        <p className="text-center text-sm text-[#666] mt-4 leading-relaxed font-medium">
          学员持有效证书可免费终身复读<br/>
          <span className="text-[#888] font-semibold">拒绝「鸡血」· 谢绝「鸡汤」· 绝非「教练技术」</span>
        </p>
      </div>
      ...
      <div className="px-5 pt-4 pb-2 text-center">
        ...
        <button
          ...
          className="mt-4 px-6 py-2.5 rounded-full bg-gradient-to-r from-[#c9a84c] to-[#b89430] text-white text-sm font-bold shadow-md active:scale-95 transition-transform"
        >
          联系亦须先生
        </button>
      </div>
      ...
      {showContact && (
        ...
        >
          <div
            className="bg-white rounded-2xl p-6 m-4 max-w-xs w-full animate-fade-in-up relative"
          ...
          >
            ...
            <div className="text-center">
              <h3 className="text-base font-bold text-[#1a1a1a] font-song mb-1">联系亦须先生</h3>
              <p className="text-xs text-[#999] mb-4">合作 / 课程咨询</p>
                ...
                <div className="rounded-lg overflow-hidden border-2 border-[#c9a84c]/20 bg-white">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.parentElement!.innerHTML = '<div class="w-36 h-36 flex items-center justify-center text-[#999] text-xs text-center px-2">二维码加载失败<br/>请暂加微信 859022196</div>';
                    }}
                  />
                </div>
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-gradient-to-r from-[#c9a84c] to-[#b89430] text-white text-xs font-bold active:scale-95 transition-transform"
              >
                <Download size={14} />
                下载二维码
              </a>
